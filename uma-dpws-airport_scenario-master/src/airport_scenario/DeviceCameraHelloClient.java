 ...
 */
public class DeviceCameraHelloClient extends DefaultClient {
	...
	public static void main(String[] args) {
		...
		// create client
		DeviceCameraHelloClient client = new DeviceCameraHelloClient();
		
		// register hello listening for all possible domains (without loopback
		// interfaces)

		// if you want to listen for loopback interfaces too, you must add call
		// public void registerHelloListening(SearchParameter search,
		// DiscoveryAutoBinding binding) for creating an autobinding see chapter
		// Autobinding
