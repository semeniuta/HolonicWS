...
public class CameraSetPictureOperation extends Operation {

	public final static String	NAME		= "SetPictureOperation";
	public final static String	ATTACHMENT	= "InputAttachment";

	public CameraSetPictureOperation() {
		super(NAME, ServicePictures.QN_PORTTYPE);
		Element attachment = new Element(new QName(ATTACHMENT, ServicePictures.namespace), SchemaUtil.TYPE_BASE64_BINARY);
		setInput(attachment);
	}
			...
			try {
				...
				switch (attachmentType) {
					case Attachment.FILE_ATTACHMENT:
						...
						OutputStream out = new FileOutputStream(new File("/home/felix/Dropbox/UMA/workspace/eclipse/AirpotExample/attachments/output"));
